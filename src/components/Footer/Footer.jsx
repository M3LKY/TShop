    ...
    <div className="footer">
      <div className="footer-content">
        <div className="col">
          ...
          <div className="text">
            Welcome to TECH-STORE, your one-stop destination for top-tier
            technology from Apple, Razer, Asus, and Msi. Experience innovation
            at its finest.
          </div>
        </div>
        <div className="col">
